						      ...
						      <div class="modal-body">
								<div class="form-group">
									<select name="type_of_vaccine" class="form-control curve" required>
										...
										<option>Aztracenca</option>
										<option>Moderna</option>
										<option>Pfizer</option>
									</select>
								</div>
								 <div class="form-group">
								 <label for="fvd">First Vaccination Date</label>
						        	<input type="date" class="form-control curve" placeholder="First Vaccination Date" name="vaccine_start">
						        </div>
								<div class="form-group">
								<label for="lvd">Second Vaccination Date</label>
						        	<input type="date" class="form-control curve" placeholder="Second Vaccination Date" name="vaccine_end">
						        </div>				        
						        <div class="form-group">
						        <button type="button" class="btn float-right" data-dismiss="modal"><img src="img/down.svg" width="20px"></button>
						        </div>
